...
from cs336_basics.transformer_modules import Linear, Embedding, RMSNorm, SwiGLU, RotaryPositionalEmbedding
...
def get_tokenizer(
    ...
    T = Tokenizer(vocab=vocab, merges=merges, special_tokens=special_tokens)
...
def run_train_bpe(
    ...
    **kwargs,
    ...
    return T.train_bpe(input_path, vocab_size, special_tokens) 
